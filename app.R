# Title: Data Explanatory Shiny App
# Date Commence: 2 December 2021
# By: Hafizuddin
# Maintainer: 
# Objective: To deploy data explanatory shiny web app
# Version: 1.0
# Date Modified:
# Input Data: Data input by user in CSV or RDS format
# Output: Explanatory analysis of the data on the app
